...
\usepackage{fontawesome5}                   % Icons (email, phone, etc.)
...
\newcommand{\gscholar}[1]{\href{https://scholar.google.com/citations?user=haAJZpIAAAAJ}{#1}}

% Colored icon helper (uses theme color) + fixed-width icon box for alignment
\newcommand{\icn}[1]{\textcolor{color-title}{#1}}
\newcommand{\icnbox}[1]{\makebox[1.1em][c]{\textcolor{color-title}{#1}}}
